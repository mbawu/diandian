 ...
 *旅游地产Activity
 */
public class TravelingActivity extends Activity implements OnClickListener {
	private ListView lv; // 旅游地产ListView
	private Myad ad; // ListView适配器
	private ArrayList<GroupBean> al; // ListView数据源
	private int page = 1; // 请求页数
	private int totalpage = 1; // 总页数
	private int lastitem; // 滑动到的最后item
	private Boolean jiazai = true; // 数据是否加载完毕
	private Button intercept; // 拦截按钮
	private View footView; // listView 角标
	...
	private void initlistener() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent in = new Intent(TravelingActivity.this,
						HouseDetails.class);
				in.putExtra("id", id);
				startActivity(in);
	...
	private void initview() {
		mTitleBar = new TitleBarContainer(findViewById(R.id.title_layout), R.string.title_travel);
	...
	private class Myad extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			price.setText(StringUtils.getPriceString(TravelingActivity.this, gb.getPrice()));
			commission.setText(StringUtils.getPriceCommission(TravelingActivity.this, gb.getScale_price()));
			area_name.setText("(" + gb.getAreaName() + ")");
			day.setText(gb.getDay());
			hour.setText(gb.getHour());
			recommend.setTag(gb);
			recommend.setOnClickListener(TravelingActivity.this);
			return convertView;
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.recommend:
			if (MyApplication.login) {
				...
				startActivity(new Intent(TravelingActivity.this, LoginActivity.class));
			}
			break;
		default:
